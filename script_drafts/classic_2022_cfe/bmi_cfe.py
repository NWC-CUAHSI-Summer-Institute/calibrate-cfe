...
#         lateral_flow_linear_reservoir_constant *= 3600.0                                              # Not used
        ...
        self.precip_check_before_run = []
        self.precip_check_after_run = []
    ...
    def run_unit_test(self, plot_lims=list(range(490, 550)), plot=False, print_fluxes=True):
        ...
        self.current_time = pd.Timestamp(self.forcing_data['date'][0])
        
        for t, precipitation_input in enumerate(self.forcing_data['total_precipitation']):
